...
*/
   ...
   /*Testimonial Slider*/
   jQuery(".tw-testimonial-carousel").owlCarousel({
      items: 1,
      loop: true,
      autoplay: true,
      nav: false,
...
$(function ($) {
   ...
   /* Testimonial Slider */
   if (jQuery(".testimonial-carousel-gray").length > 0) {
      jQuery(".testimonial-carousel-gray").owlCarousel({
         items: 2,
         margin: 20,
         loop: true,
         autoplay: true,
   ...
   if (jQuery(".testimonial-box-carousel").length > 0) {
...
//   });
   ...
   jQuery('.mission-carousel').owlCarousel({
      items: 1,
      loop: true,
      nav: false,
      dots: true,
